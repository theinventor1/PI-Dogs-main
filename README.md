...
> [**IMPORTANTE**]: es requisito que el formulario de creación esté validado sólo con JavaScript. Puedes agregar las validaciones que consideres. Por ejemplo: que el nombre de la raza no pueda contener números, o que el peso/altura mínimo no pueda ser mayor al máximo.
...
curl --location 'https://api.thedogapi.com/v1/images/search' --header 'Content-Type: application/json' --header 'x-api-key: live_ZfLtEnElDpewJMvadPWb8wUz0ot68ZQdARpOUsPaZPWpdFwtjDc0iemAm3FEExFE'




[{"breeds":[{"weight":{"imperial":"130 - 180","metric":"59 - 82"},"height":{"imperial":"25.5 - 27.5","metric":"65 - 70"},"id":212,"name":"Saint Bernard","bred_for":"Draft, search, rescue","breed_group":"Working","life_span":"7 - 10 years","temperament":"Friendly, Lively, Gentle, Watchful, Calm","reference_image_id":"_Qf9nfRzL"}],"id":"KozrdsGZv","url":"https://cdn2.thedogapi.com/images/KozrdsGZv.jpg","width":1080,"height":1306}]
